...
public class Mission2Community : Mission
{
    ...
    [SerializeField] TMP_Text Deadtxt, bio, nonBio, Congratstxt, exitpromt, School, RottenBanana;
    ...
    "Congratulations for finishing the level 2 of community map! This is your reward!",
    ...
    "Binabati kita sa pagtapos sa level 2 ng community map! Ito ang iyong reward!",
    ...
    void Update()
    {
        ...
        missionText[2].text = "Defeat 5 trash monsters: " + GetMissionReqNum(2) + " /5";
    ...
    void ChangeLanguage(string language)
    {
        if (language == "filipino")
        {
            ...
            RottenBanana.text = Filipino_dialogues[6];
        ...
        else
        {
            ...
            RottenBanana.text = English_dialogues[6];
